...
🔗 **배포 주소:** https://dd15963-max.github.io/Carimatec-Resin-Guide-V2/
...
1. `admin.html`을 브라우저로 엽니다.
   - 온라인: https://dd15963-max.github.io/Carimatec-Resin-Guide-V2/admin.html
...
- 주소를 아는 사람은 접근 가능합니다(비밀번호 없음). 외부에 admin 주소를 공유하지 마세요.
